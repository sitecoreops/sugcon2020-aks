...
$MicroCHAP = Join-Path $ScriptPath "\..\bin\MicroCHAP.dll"
...
Sync-Unicorn -ControlPanelUrl 'http://localhost/unicorn.aspx' -SharedSecret "$($env:SITECORE_SETTINGS_UNICORN_SHARED_SECRET)"
